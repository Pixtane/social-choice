...
def main():
    ...
    print("\nPhases:")
    print("1. Voter scaling (8 voter counts × 200 profiles × 3 configs = ~4800 simulations)")
    print("2. Threshold sweep (19 thresholds × 200 profiles × 3 configs = ~11400 simulations)")
    print("3. Dimensional scaling (7 dimensions × 200 profiles × 3 configs = ~4200 simulations)")
    print("4. Metric pairs (12 pairs × 200 profiles × 4 configs = ~9600 simulations)")
    print("5. Final verification (12 pairs × 200 profiles × 4 configs = ~9600 simulations)")
    print("\nTotal: ~39,600 simulations")
